...
function HamburgerIcon() {
  return (
    <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M3 5.5h16M3 11h16M3 16.5h16" stroke="var(--text-subtle, #4b5563)" strokeWidth="1.8" strokeLinecap="round"/>
    </svg>
  );
}
...
function CloseIcon() {
  return (
    <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M5 5l12 12M17 5L5 17" stroke="var(--text-subtle, #4b5563)" strokeWidth="1.8" strokeLinecap="round"/>
    </svg>
  );
}
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="nav-right-desktop" style={{ display: "flex", alignItems: "center", gap: 32 }}>
          <form onSubmit={handleSearch} style={{ position: "relative", flexShrink: 0 }}>
            <img
              ...
              alt=""
              style={{ position: "absolute", left: 11, top: "50%", transform: "translateY(-50%)", width: 16, height: 16, pointerEvents: "none" }}
            />
            <input
              value={searchQuery}
        ...
        {/* 모바일 검색창 — 햄버거 왼쪽, 모바일에서만 표시 */}
        <form
          className="nav-search-mobile"
          onSubmit={handleSearch}
          style={{ display: "none", position: "relative", flex: 1, maxWidth: 180, margin: "0 6px 0 8px" }}
        >
          <img
            src="/icons/search-icon.svg"
            alt=""
            style={{ position: "absolute", left: 9, top: "50%", transform: "translateY(-50%)", width: 15, height: 15, pointerEvents: "none" }}
          />
          <input
            value={searchQuery}
            onChange={(e) => setSearchQuery(e.target.value)}
      ...
      {menuOpen && (
        <div
          style={{
            background: "var(--bg-main, #f0f2f5)",
            borderTop: "1px solid var(--border-subtle, #dde1e6)",
            borderBottom: "1px solid var(--border-subtle, #dde1e6)",
        ...
        >
          ...
          {/* 구분선 */}
          <div style={{ height: 1, background: "var(--border-subtle, #dde1e6)", margin: "8px 0" }} />
